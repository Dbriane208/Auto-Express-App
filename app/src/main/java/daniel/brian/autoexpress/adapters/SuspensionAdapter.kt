...
class SuspensionAdapter: RecyclerView.Adapter<SuspensionAdapter.SuspensionViewHolder>() {
    inner class SuspensionViewHolder(private val binding: ProductRvBinding): RecyclerView.ViewHolder(binding.root) {
